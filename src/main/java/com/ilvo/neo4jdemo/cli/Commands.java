...
import com.ilvo.neo4jdemo.nodes.properties.BornYear;
...
import com.ilvo.neo4jdemo.relationships.properties.Rating;
import com.ilvo.neo4jdemo.relationships.properties.Roles;
import com.ilvo.neo4jdemo.relationships.properties.Summary;
import com.ilvo.neo4jdemo.service.PersonService;
import com.ilvo.neo4jdemo.service.MovieService;
...
public class Commands {
    ...
    public void reviewed(String name, String title, String summaty, Integer rating){
        ...
        personService.reviewed(Name.of(name),Title.of(title),Summary.of(summaty),Rating.of(rating));
    ...
    public void queryPropertiesReviewed(String name, String title){
		...
		terminal.writer().print(reviewedProperties.getSummary());
		terminal.writer().println("the rating of Reviewed relationship between "+name+" and "+title+" :");
		terminal.writer().print(reviewedProperties.getRating().toString());
